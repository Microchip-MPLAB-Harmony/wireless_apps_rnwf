...
typedef enum
{
    ...
    APP_STATE_WINCS_PRINT_CERTS,
            
    // State to print certs and keys on device 
    APP_STATE_WINCS_PRINT_KEYS,
    ...
    APP_STATE_WINCS_WAIT,
            
    APP_STATE_WINCS_WIFI_DISCONNECT,
...
//{
//    APP_WINCS02_WIFI_CONN_STATUS = 0,
//    APP_WINCS02_SNTP_CONN_STATUS,
//    APP_WINCS02_MQTT_CONN_STATUS,
//            
...
void APP_WINCS02_StaCmdInitialize ( void );
void APP_WINCS02_Initialize ( void );
void APP_WINCS02_Tasks ( void );
//bool APP_WINCS02_GetStatus (APP_WINCS02_DEV_STATUS devStatus);
