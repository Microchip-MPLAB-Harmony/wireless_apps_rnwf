...
static SYS_RNWF_WIFI_SECURITY_t SYS_RNWF_PROV_ParseAuth(uint8_t secType)
{
    ...
    switch(secType)
    {
        ...
        default:
        #ifdef SYS_RNWF_PROV_DEBUG_LOGS
...
SYS_RNWF_RESULT_t SYS_RNWF_PROV_SrvCtrl(SYS_RNWF_PROV_SERVICE_t request, void *input)  {
    ...
    switch(request)
    {
        ...
        {                   
            ...
            /* Wi-Fii Connectivity */
            SYS_RNWF_WIFI_PARAM_t wifi_ap_cfg = {SYS_RNWF_WIFI_MODE_AP, SYS_RNWF_WIFI_PROV_SSID, SYS_RNWF_WIFI_PROV_PWD, SYS_RNWF_PROV_SECURITY,SYS_RNWF_WIFI_CHANNEL};    
            SYS_RNWF_WIFI_SrvCtrl(SYS_RNWF_SET_WIFI_PARAMS, &wifi_ap_cfg);
            SYS_RNWF_PROV_DBG_MSG("Provision mode : Mobile app\r\n");
            SYS_RNWF_PROV_DBG_MSG("SSID:%s - PASSPHRASE:%s - AUTH:%d\r\n", 
                                wifi_ap_cfg.ssid, 
