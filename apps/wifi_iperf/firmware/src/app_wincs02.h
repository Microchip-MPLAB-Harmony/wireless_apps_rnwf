...
#ifndef _APP_WINCS02_H
#define _APP_WINCS02_H
...
typedef enum
{
    ...
    APP_STATE_WINCS_SOCKET_OPEN,
    APP_STATE_WINCS_SEND_WEBPAGE,
...
/*******************************************************************************
  ...
  Description:
    ...
    APP_WINCS02_Tasks function can be called.
